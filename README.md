# Pitch-length-measurement-in-LC-research
A script can work interactively with ImageJ to measure pitch length from the picture captured from a chiral LC phase by a polarizing light microscope.
